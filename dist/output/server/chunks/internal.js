...
const options = {
  ...
  templates: {
    app: ({ head, body, assets: assets2, nonce, env }) => '<!doctype html>\r\n<html lang="en">\r\n\r\n<head >\r\n	<meta charset="utf-8" />\r\n	<link rel="icon" href="' + assets2 + `/ndc.png" />\r
	<meta name="viewport" content="width=device-width, initial-scale=1" />\r
	<meta name="viewport" content="width=device-width, initial-scale=1.0" />\r
	<meta name="description" content="Stay updated with the latest notices from NDC Group 14 Notice Board." />\r
	<meta name="keywords" content="NDC, Notre Dame College, Dhaka, Notices, Notice Board, Group 14, Education" />\r
	<meta name="author" content="Tahcin Ul Karim (Mycin)" />\r
	<meta property="og:title" content="NDC Group 14 Notice Board" />\r
	<meta property="og:description" content="Latest notices and updates from Notre Dame College, Dhaka." />\r
...
\r
<body style="position: relative; background: none;" class="text-gray-900 dark:text-gray-100 min-h-screen"\r
	data-sveltekit-preload-data="hover">\r
	<div class="absolute inset-0 bg-cover bg-center bg-fixed"\r
		style="background-image: url('/harrington.jpg'); z-index: -1;">\r
		<!-- Dark overlay -->\r
		<div class="absolute inset-0 bg-black opacity-50"></div>\r
	</div>\r
