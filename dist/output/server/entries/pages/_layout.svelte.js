import { O as store_get, P as ensure_array_like, Q as unsubscribe_stores, N as pop, R as stringify, J as push, S as head, T as slot } from "../../chunks/index3.js";
import "clsx";
...
function _layout($$payload, $$props) {
  ...
  head($$payload, ($$payload2) => {
    $$payload2.title = `<title>NDC Group 14 Notice Board</title>`;
  });
  $$payload.out += `<div class="flex flex-col min-h-screen bg-cover bg-center">`;
  Navbar($$payload);
